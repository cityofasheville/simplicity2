	...
	if (
		...
		bannerContent = (
			<div role={"alert"} className="bg-warning mt-8 p-4 text-black border border-slate rounded">
				...
				<p>
					This is an experimental version of SimpliCity, and may produce unexpected results. Unless you understand how
					you've ended up here, we recommend{" "}
					<a href={`https://simplicity.ashevillenc.gov${productionPathAddons}`} className="text-black">
