    ...
    <footer className="footer">
      <div className="container">
        <div className="col-sm-12">
          <div style={{ fontStyle: 'italic' }} className="text-center">We strive for full accessibility. Report issues using our <a className="inText" href="https://goo.gl/forms/XC9l7PTylog6Q9B83" target="_blank" rel="noopener noreferrer" title="feedback form link">feedback form</a>.
          </div>
