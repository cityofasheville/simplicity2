  ...
  <div>
    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="col-sm-2 old-version-link col-xs-12" style={{ fontStyle: 'italic', marginRight: '0px' }}><a className="inText pull-right" href="https://simplicity-old.ashevillenc.gov" target="_blank">View old version</a></div>
      </div>
    </footer>
  </div>
);
