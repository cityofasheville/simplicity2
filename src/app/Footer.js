  ...
  <div>
    ...
    <footer className="footer" style={{ paddingTop: '2px' }}>
      <div className="container">
        ...
        <div className="col-sm-2" style={{ fontStyle: 'italic', marginRight: '0px' }}><a className="inText pull-right" href="https://www.simplicity-old.ashevillenc.gov" target="_blank">View old version</a></div>
      </div>
    </footer>
  </div>
);
