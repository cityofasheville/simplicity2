          ...
          <div className="container-fluid navbar__inner">
            <div className="navbar-header">
              ...
              <div className="pull-left">
                <IndexLink to="/">
                  <div className="logo">
                    <img src={require('./citylogo-flatblue.png')} alt="City of Asheville logo" />
            ...
            <div className={[this.state.navbarCollapse, 'navbar-collapse'].join(' ')}>
              <ul className="nav navbar-nav navbar-right">
                ...
                <li>
                  <Link
                    to="https://docs.google.com/a/ashevillenc.gov/forms/d/e/1FAIpQLSdjNwOmoDY3PjQOVreeSL07zgI8otIIPWjY7BnejWMAjci8-w/viewform?c=0&w=1"
                    target="_blank"
                ...
                <li>
                  <a
                    onClick={() => {
                      browserHistory.push('/search?entities=address,property,neighborhood,street,owner,google');
                    }}
                  >
