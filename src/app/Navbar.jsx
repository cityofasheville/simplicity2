...
function Navbar() {
	...
	return (
		<header className="w-full bg-sky-100 border-b border-blue-dark">
			<nav className="w-full flex flex-col md:flex-row md:items-center md:justify-between" aria-label="Main navigation">
				...
				<div id="menu-container" className={`${navbarOpen ? "block w-full" : "hidden"} w-full md:w-auto md:block`}>
