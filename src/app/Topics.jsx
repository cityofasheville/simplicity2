...
import { IM_TREE } from '../shared/iconConstants';
import Icon from '../shared/Icon';

const Topics = (props) => (
  <div className="pt-5">
    <h2 className="text-3xl text-coa-blue-medium pb-3">Explore topics related to your community</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      {props.topics.map((topic, i) => (
        <div className="py-4" key={['topic', i].join('_')}>
          <TopicCard
            topic={topic.name}
            lang={props.language.language}
            view={null}
