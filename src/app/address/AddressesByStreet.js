...
const dataColumns = [
  {
    ...
    filterMethod: (filter, row) => {
      const joinedAddressInfo = [row._original.street_number, row._original.street_prefix, row._original.street_number, row._original.unit, row._original.city, ',NC', row._original.zipcode].join(' ');
