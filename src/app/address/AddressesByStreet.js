...
const AddressesByStreet = (props) => {
  ...
  const mapData = props.data.addresses_by_street.map(item =>
    Object.assign({}, item, {
    ...
    <div>
      <div className="row">
        <div className="col-sm-12">
          <EmailDownload
            downloadData={props.data.addresses_by_street}
            fileName="addresses_by_street.csv"
          />
        </div>
          ...
          {props.data.addresses_by_street.length < 1 ? (
            ...
            <div style={{ marginTop: '10px' }}>
              <AccessibleReactTable
                ...
                defaultPageSize={
                  props.data.addresses_by_street.length <= 20
                    ? props.data.addresses_by_street.length
                    : 20
                }
                getTdProps={() => ({
                  style: {
