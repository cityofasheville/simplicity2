...
const BudgetSummary = props => (
  <div>
    <PageHeader h1="Proposed Budget 2017-2018" externalLinkText="Full budget document" externalLink="http://www.ashevillenc.gov/civicax/filebank/blobdload.aspx?blobid=27587" dataLinkPath="/budget/data" icon={<Icon path={IM_COIN_DOLLAR} size={45} />}>
      <ButtonGroup>
