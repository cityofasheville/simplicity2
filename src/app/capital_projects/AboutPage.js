			...
			<div style={{ marginTop: "15px" }}>
				<div>
					...
					<p style={paragraphStyle}>
						...
						Capital projects traditionally take the form of large-scale physical developments, such as buildings,
						streets and other infrastructure. However, a wide range of other projects also qualify for capital funding
						consideration, such as heavy duty vehicles and computer software.
					</p>
					<p style={paragraphStyle}>
						<span
							style={{
						...
						All projects within the City’s Capital Improvement Program (CIP) are funded with a mix of internal City
						resources and external resources such as grants and partnerships.{" "}
					</p>
					<ul>
						<li>
					...
					<p style={paragraphStyle}>
						...
						The City of Asheville has more demand for infrastructure projects than it has funds and staff capacity to
						execute them, which is why strategically sequencing projects is important. The City identifies potential
						capital improvement projects using technical assessments of infrastructure condition and need, as well as
						public input. Projects are evaluated and prioritized based upon many criteria, including:
					</p>
