  ...
  return (
    <div>
      <div className="relative h-[500px] w-full">
        ...
        >
          This map contains information which is also represented in the table below. Press enter to
          skip to the table or tab to continue to the map.
        </a>
        <CIPMap
          data={mapData}
      ...
      <div className="mt-3">
        ...
        <div className="px-3 py-4 outline outline-[3px] outline-coa-blue-medium">
          <div className="mb-3">
            <button
              className="btn btn-primary py-[2px] px-[5px] text-[14px]"
