  ...
  return (
    <div>
      <a href="http://arcg.is/Sy5KC" className="pull-right" target="_blank">
        <div className="alert alert-warning alert-sm" style={{ position: 'absolute', right: '30px', top: '150px', cursor: 'pointer', zIndex: '1000' }}>Try our Project Map to search geographically and by address.
        </div>
      </a>
