...
const CapitalProjectsSummary = props => {
  ...
  return (
    <div>
      <PageHeader h1="Capital Projects" dataLinkPath="/capital_projects/data" externalLinkText="View the CIP plan pdf" externalLink="http://www.ashevillenc.gov/civicax/filebank/blobdload.aspx?blobid=26386#page=125" icon={<svg xmlns="http://www.w3.org/2000/svg" width="69" height="69">
      ...
      <CIPFilter selected={getSelected()} />
      <hr />
      <CategoryDetails location={props.location} />
    </div>
  );
};
