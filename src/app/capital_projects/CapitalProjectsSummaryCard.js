...
const CapitalProjectsSummaryCard = props => (
  <div>
    <div className="summaryCard" style={{ borderRadius: '5px', border: props.selected ? '8px solid #16abe4' : '8px solid #ffffff', opacity: props.disabled ? '0.25' : (props.selected ? '1.0' : '0.75'), backgroundColor: '#4077a5', marginBottom: '15px' }}>
