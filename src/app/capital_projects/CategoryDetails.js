      ...
      return (
        ...
        >
          <g fill="none" fillRule="evenodd" id="Icons with numbers" stroke="none" strokeWidth="1">
            <g fill="#4077a5" id="Group" transform="translate(-528.000000, -576.000000)">
              <path
  ...
  <div>
    <p>
      ...
      <span style={{ marginLeft: '5px' }}>
        {categories.slice(0, categories.length - 1).join(', ')} {categories.length > 1 ? 'and' : ''}{' '}
        {categories[categories.length - 1]} projects within the City’s General Capital Improvement
        Program (CIP) are funded with a combination of general tax revenue, municipal debt and
        external grants or partnerships.
      </span>
      {categories.includes('Other') && (
        <span>
          &nbsp;Projects categorized as &quot;Other&quot; support facility upgrades and economic
...
const CategoryDetails = (props) => {
  ...
  if (props.location.query.mode === 'bond') {
    actualCategories = actualCategories.filter(cat =>
      ['Transportation', 'Parks', 'Housing'].includes(cat));
  }
        ...
        <div className="col-sm-12">
          <div className="funding-summary">
            <div className="col-sm-4 col-xs-4">
              <h2>
                <span className="label-text">Total funding:</span>{' '}
            ...
            <div className="col-sm-4 col-xs-4">
              <h2>
                ...
                <span className="amount">{getDollars(fundingDetails[0]['Expended funds'])}</span>
              </h2>
            </div>
            <div className="col-sm-4 col-xs-4">
              <h2>
                <span className="label-text">Under contract:</span>{' '}
                <span className="amount">{getDollars(fundingDetails[0]['Under contract'])}</span>
              </h2>
            </div>
          </div>
          <div className="row">
                  ...
                  <div>
                    <p>
                      <span style={{ fontStyle: 'italic' }}>
                        Please note: Current project budgets include prior year funding and may
                        change throughout the life of the project.
                      </span>
                    </p>
                    <p>
                      <span style={{ fontStyle: 'italic' }}>
                        Ongoing programs and regular maintenance projects may not be represented in
                        this dashboard. For a complete list including ongoing and maintenance
                        projects within the City&apos;s General CIP, please view the adopted{' '}
                        <a
                          className="inText"
                          href="http://www.ashevillenc.gov/civicax/filebank/blobdload.aspx?blobid=28348#page=146%20"
                          target="_blank"
                        >
                          FY 17-18 Annual Budget
                        </a>.
                      </span>
                    </p>
                  </div>
