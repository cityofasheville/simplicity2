...
import { IM_SHEILD3, IM_TREE3, IM_HOME2, IM_BUS } from '../../shared/iconConstants.js';
...
const dataColumns = [
  {
    ...
    Cell: (row) => (
      <span>
        <span>{getIcon(row.original.Category, row.isExpanded)}</span>
