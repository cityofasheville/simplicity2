...
function ProjectsTableRefactor(props) {
    ...
    () => [
      {
        ...
        cell: (cell) => (
          <span>
            ...
            {cell.row.original.display_name}</a>
            </span>
          </span>
        ),
      },
      ...
      //   accessorKey: `type`,
      //   id: 'types',
      //   header: (<button aria-label="sort by type" style={{
      //     cursor: 'pointer',
      //     borderRadius: '0px',
      //     border: "1px solid rgba(0, 0, 0, .02)",
      //     padding: "10px",
                                      ...
                                      style: {
                                        boxShadow:
                                          header.column.getIsSorted() === "asc"
                                            ? "inset 0 4px 0 0 #4077a5" // Inset top border for ascending
                                            : header.column.getIsSorted() ===
                                              "desc"
                                            ? "inset 0 -4px 0 0 #4077a5" // Inset bottom border for descending
                                            : "none", // No shadow when not sorted
                                      },
                                    }}
                                  >
                                    {flexRender(
...
export default ProjectsTableRefactor;
