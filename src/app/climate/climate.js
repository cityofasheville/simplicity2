...
const Climate = (props) => {
	...
	return (
		<div className="container" style={{ padding: "0" }}>
			...
			>
				...
				<p>
					...
					<a href="https://avl.maps.arcgis.com/apps/instant/lookup/index.html?appid=10e2c4ae45614b92ad4efaa61342b249%2F">
						Citywide Climate Vulnerability Score Map
					</a>
				...
				<div className="col-xs-12 col-sm-6 col-lg-4" style={{ margin: "24px 0" }}>
					<ClickableTile
						image={IMG_CJI_MAP}
						text="Community Climate Vulnerability Index Map"
				...
				{/* <div className="col-xs-12 col-sm-6 col-lg-3" style={{ margin: "24px 0" }}>
					<ClickableTile
						image={IMG_CJI_WEB}
			...
			></div>
			<h3>
				Climate Vulnerability Score Score:{" "}
				<span
					style={{
			...
			<ul className="cjdata">
				...
				<li>
					<h4>Heat Vulnerability Score: {props.data.blockgroups[0].heat_score}</h4>
					<ul>
						<li>
				...
				<li>
					<h4>Climate Resiliency Neighborhood Threats Score: {props.data.blockgroups[0].resiliency}</h4>
					<ul>
						<li>
