	...
	return (
		<Banner>
			<div className="max-w-3xl mx-auto">
				<p className="text-2xl font-semibold text-center">Climate pages temporarily unavailable.</p>{" "}
				<p className="text-center">We are working on updating these pages. Please check back soon.</p>
			</div>
		</Banner>
	);
