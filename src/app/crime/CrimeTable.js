...
import { IM_SHIELD3, IM_MAP5, LI_USER_QUESTION, IM_LIBRARY2, LI_CAR_CROSS, IM_FENCE, LI_CAR_LOCK2, IM_PENCIL7, LI_BILL_DOLLAR, LI_MONEY_POUCH, IM_AID_KIT2, LI_HAMMER, LI_AMBULANCE, IM_PROFILE, LI_BUBBLE_MAD, IM_GUN_FORBIDDEN } from '../../shared/iconConstants';

const getIcon = (type, isExpanded) => {
  switch (type) {
    case 'MISSING PERSON REPORT':
    case 'RUNAWAY JUVENILE':
      return <Icon path={LI_USER_QUESTION} size={24} viewBox="0 0 24 24" color={isExpanded ? '#fff' : '#4077a5'} />;
    case 'DAMAGE TO PERSONAL PROPERTY':
    case 'VANDALISM':
      return <Icon path={LI_HAMMER} size={24} viewBox="0 0 24 24" color={isExpanded ? '#fff' : '#4077a5'} />;
    case 'ASSAULT - SIMPLE':
    ...
    case 'COMMUNICATING THREAT':
      return <Icon path={LI_BUBBLE_MAD} size={24} viewBox="0 0 24 24" color={isExpanded ? '#fff' : '#4077a5'} />;
    ...
    case 'UNAUTHORIZED USE OF MOTOR VEHICLE':
      return <Icon path={LI_CAR_CROSS} size={24} viewBox="0 0 24 24" color={isExpanded ? '#fff' : '#4077a5'} />;
    case 'LARCENY OF MV OTHER':
    case 'LARCENY OF MV AUTO':
    case 'LARCENY OF MV TRUCK':
      return <Icon path={LI_CAR_LOCK2} size={24} viewBox="0 0 24 24" color={isExpanded ? '#fff' : '#4077a5'} />;
    case 'TRESPASS':
    ...
    case 'ROBBERY - ARMED - KNIFE':
      return <Icon path={LI_MONEY_POUCH} viewBox="0 0 24 24" size={24} color={isExpanded ? '#fff' : '#4077a5'} />;
    default:
