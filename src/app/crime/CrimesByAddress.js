...
function CrimesByAddress(props) {
  return (
    <Query
      ...
      variables={{
        civicaddress_id: props.location.query.id
          ? +props.location.query.id.trim()
          : "9688",
        radius: +props.radius,
        before: props.before,
        after: props.after,
                  ...
                  <Map
                    ...
                    center={
                      props.location.query.x !== ""
                        ? [
                            parseFloat(props.location.query.y),
                            parseFloat(props.location.query.x),
                          ]
                        : null
                    }
