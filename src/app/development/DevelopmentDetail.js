						...
						<div className="row">
							<div className="col-xs-12 detailsFieldset__details-listings">
								...
								<div style={{ padding: "0 15px" }}>
									<a
										href={["https://www.google.com/maps/?q=", [props.data.y, props.data.x].join(",")].join("")}
										target="_blank"
									...
									<div name="address" style={{ marginTop: "8px" }}>
										{props.data.address}
									</div>
									<div style={{ marginTop: "16px" }}>
										<a href={`/permits/${props.data.permit_number}`} target="_blank" rel="noopener noreferrer">
