...
const Permit = (props) => (
  ...
  >
    {({ loading, error, data }) => {
        ...
        return (
          <div className="container">
            ...
            <div className={`alert alert-danger`} style={{ margin: '2rem 0' }}>
              There was an error retrieving permit number "{props.routeParams.id}" - {error.message}
              . If this problem perists, please contact help@ashevillenc.gov.
            </div>
        ...
        return (
          <div className="container">
            ...
            <div className={`alert alert-warning`} style={{ margin: '2rem 0' }}>
              No permit found for ID "{props.routeParams.id}". Please verify the permit ID and try
              again.
            </div>
            <SuggestSearchWrapper searchMode="permit" />
          </div>
      ...
      const currentStatusItem = statusTranslation.find(
        (item) => item.accelaSpeak === formattedPermit.status_current,
      );
      ...
      const resubmittalPortal =
        'https://www.ashevillenc.gov/department/development-services/development-portal/revised-application-amendment/';
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
                                    ...
                                    .map((zoning, index) => {
                                      ...
                                      return (
                                        <span key={`zoning=${index}`}>
                                          ...
                                          <a
                                            href={
                                              formattedPermit.address_info.zoning_links.split(',')[
                                                index
                                              ]
                                            }
                                            target="_blank"
            ...
            <div className="">
              ...
              <h3 className="text-2xl text-coa-blue-medium my-5">
                For Applicants: Work with this Application
              </h3>
          ...
          {trcType !== undefined && (
            <div className="flex my-6">
              <p>
                <em>
                  This is an application made for development or permitting by a private individual
                  that is being reviewed by the City of Asheville.
                  <a href="/development/major">Learn more</a> about the development review process
                  in Asheville.
                </em>
              </p>
            </div>
