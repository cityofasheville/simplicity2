...
const introductoryContent = (
	<header className="pb-8">
		...
		<p className="mb-2">There is a lot of private land development happening in Asheville. This tool can help you:</p>
		<ul className="list-disc ml-10 mb-2">
			<li className="">Understand the development process from the first permit application to breaking ground</li>
		...
		<p>
			Do you have ideas for how this tool could be updated or refined to better serve our community? If so, please{" "}
			...
			<div id="majorDevDash" className="container-fluid h-100">
				<nav>
					<ul className="sectionNav">
						{/* <ul className="sectionNav w-[12.5vw] min-w-[200px] h-full z-100 fixed bg-gray-200 border-r left-0 top-[97px] "> */}

						<li>
							<a href="#types" className="linkItem-not-selected">
								Project Types
							</a>
						</li>
						<li>
							<a href="#process" className="linkItem-not-selected">
								Process
							</a>
						</li>
						<li>
							<Link to="/permits/search" className="linkItem-not-selected">
								Development &amp; Permit Search
							</Link>
						</li>
						<li>
							<a href="#notifications" className="linkItem-not-selected">
								Get Notifications
							</a>
						</li>
						<li>
							<a href="#data" className="linkItem-not-selected">
								Project Details
							</a>
						</li>
						<li>
							<a href="#participate" className="linkItem-not-selected">
								Get Involved
							</a>
						</li>
						<li>
							<a href="#faq" className="linkItem-not-selected">
				...
				<main>
					<div className="mx-auto">
						...
						{devDashSections.map((section) => (
							<section id={section.linkId} key={section.linkId} className="mx-auto">
								<h2 className="text-4xl text-coa-blue-medium my-6">{section.header}</h2>
								<ErrorBoundary>{section.body}</ErrorBoundary>
							</section>
						))}
					</div>
				</main>
