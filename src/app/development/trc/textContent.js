		...
		body: (
			<React.Fragment>
				<p>
					...
					so that we can improve this page. If you have a question to which you need a response, please email
					pod@ashevillenc.gov instead.
				</p>
				<p>
...
export const devDashSections = [
	...
	},
	{
		...
		body: (
			<React.Fragment>
				<p>
					After the developer submits an application, it goes through a decision-making process that includes city
					staff, elected and appointed city officials, developers, and residents. Who is involved at what step depends
	...
	},
	{
		...
		body: (
			<p>
				You can receive an email notification when a developer submits an application for a new large-scale development.
				Visit{" "}
	...
	},
	{
		...
		body: (
			<React.Fragment>
				...
				<p className="mb-6">
					The map and table below contain proposed, large-scale, private development projects for which a permit
					application has been submitted. You can also explore permit applications using the above links.
				</p>
				<TRCDataTable />
			</React.Fragment>
		),
	},
	{
		...
		body: (
			<React.Fragment>
				<p>
					Depending on the type of project, there are a few different ways for community members to get involved in the
					development process.
				</p>
				<ul className="paragraphy-list">
					<li>
						...
						<p>
							Developers planning to submit applications for development that must go through the Technical Review
							Committee (including projects of types Level II, Major Subdivision, Conditional Zoning, and Special Use
							Permit) must hold a public meeting before submitting the application.
						</p>
						<p>
							Currently, developers are not required by law to notify the City of Asheville when those meetings take
							place. Thus, the first record the city has of a proposed development is when the application is submitted,
							after the meeting.
						</p>
						<p>
							However, in order to help ensure that residents can find out about developer-neighborhood meetings in
							advance, the city has asked developers to voluntarily notify the city. After those developers fill out an
							online form, those meeting dates are automatically added to{" "}
							<a
								target="_blank"
								rel="noopener noreferrer"
							...
							>
								a calendar that shows all developer-neighborhood meetings about which the city has been notified
							</a>
							.
						</p>
					</li>
					<li>
						...
						<p>
							As described above, there are several committees and commissions that participate in the major development
							review processs. Depending on the size, type, and location of proposed development, it may go through the{" "}
							<a
						...
						<p>
							Visit{" "}
							<a href="https://AshevilleNC.gov" rel="noopener noreferrer" target="_blank">
								AshevilleNC.gov
							</a>{" "}
					...
					<li>
						...
						<p>
							Projects of types Conditional Zoning and Special Use Permit are reveiwed in a public hearing before City
							Council. Community members may speak as individuals for three minutes or on behalf of organizations for
							ten minutes (if three other people cede their speaking time) at a council meeting.
						</p>
						<p>
							Information about City Council as well as minutes and agendas for upcoming and past council meetings can
							be found on{" "}
							<a href="https://www.ashevillenc.gov/government/" rel="noopener noreferrer" target="_blank">
...
trcProjectTypes["Level I"] = {
	...
	descriptors: {
		whyLevel: (
			<ul>
				<li>
					Not located downtown and contains 5 to 19 residential units or 500 to 34,999 square feet of commercial space
				</li>
...
trcProjectTypes["Major Subdivision"] = {
	...
	descriptors: {
		...
		participationOpp: (
			<ul>
				<li>
					<a href="/development/major#participate">Neighborhood meeting</a>
				</li>
				<li>
					<a
...
trcProjectTypes["Level II"] = {
	...
	descriptors: {
		whyLevel: (
			<ul>
				<li>
					Generally, residential developments between 19-49 unit or commerical developments between 35,000 and 99,999
					square feet
				</li>
				<li>
					Incentives for affordable housing change the review level for certain projects that may lie outside of these
					thresholds
				</li>
				<li>
					<a href="https:codelibrary.amlegal.com/codes/ashevillenc/latest/asheville_nc/0-0-4236">
		...
		recentAppsLink: (
			<a href="/development/major?permit_type=level%20II%20#data">Recently submitted Level II projects</a>
		),
	},
	color: "#2d93ad",
};
	...
	descriptors: {
		whyLevel: (
			<ul>
				...
				<li>
					...
					<a href="https:codelibrary.amlegal.com/codes/ashevillenc/latest/asheville_nc/0-0-0-4236">
						Section 7-5-9 of the UDO
					</a>
				</li>
			</ul>
		...
		participationOpp: (
			<ul>
				...
				<li>
					<a href="https://ashevillenc.gov/government" target="_blank" rel="noopener noreferrer">
						City Council
					</a>{" "}
					hearing
				</li>
...
trcProjectTypes["Special Use Permit"] = {
	...
	descriptors: {
		whyLevel: (
			<React.Fragment>
				This is highly specialized permit process for land uses with potential public impacts that require individual
				consideration of their location, design, configuration and operation. These uses are defined by{" "}
				<a
					href="https://codelibrary.amlegal.com/codes/ashevillenc/latest/asheville_nc/0-0-0-9513#JD_7-16-2"
					target="_blank"
					rel="noopener noreferrer"
				>
		...
		recentAppsLink: (
			<div>
				<span>Note: Special Use Permits are temporarily listed as "Conditional Use" within the data. </span>{" "}
				<a href="/development/major?permit_type=conditional%20use#data">Recently submitted Special Use Permits</a>
			</div>
		),
	},
	color: "#073d49",
	...
	<div className="flex justify-center">
		<div>
			...
			<div>
				...
				<span className="ml-4">Denied</span>
			</div>
			<div>
				<svg
					height="16px"
					...
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 512 512"
					className="svg-inline--fa fa-redo fa-w-16 fa-2x"
				>
					<path
						fill="currentColor"
				...
				<span className="ml-4">Revise</span>
			</div>
		</div>
	</div>
);
...
export const dagreNodes = [
		...
		subNodes: [
			{
				...
				steps: {
					...
					where: (
						<a href="https://goo.gl/maps/FYcn1ATUY7Ux8q6G9" target="_blank" rel="noopener noreferrer">
			...
			},
			{
				...
				steps: {
					...
					when: (
						<React.Fragment>
							Ten days before application submission (<a href="/development/major#calendar">see calendar</a>)
						</React.Fragment>
					),
	...
	},
	{
		...
		steps: {
			what: (
				<React.Fragment>
					...
					<a
						href="https://www.ashevillenc.gov/department/development-services/"
						rel="noopener noreferrer"
						target="_blank"
					>
		...
		typeIds: ["Level I", "Level II", "Major Subdivision", "Conditional Zoning", "Special Use Permit"],
	},
	{
		id: "Staff review",
		steps: {
	...
	},
	{
		...
		steps: {
			what: (
				<React.Fragment>
					An eight-member body that ensures that the proposed project complies with standards and requirements. Meeting
	...
	},
	{
		...
		steps: {
			what: (
				<div>
					Projects located Downtown, in the River District, or involving a historic landmark or site must be reviewed
					for architectural design elements by a special design review sub-committee of the{" "}
					<a
						href="https://www.ashevillenc.gov/department/city-clerk/boards-and-commissions/downtown-commission/"
						target="_blank"
						rel="noopener noreferrer"
			...
			where: (
				<ul className="p-0">
					<li>
						Downtown Commission:{" "}
						<a href="https://goo.gl/maps/7GkCkb1pPjRaXbAc7" target="_blank" rel="noopener noreferrer">
							City Hall
						</a>
					</li>
					<li>
						Riverfront Commission:{" "}
						<a href="https://goo.gl/maps/Wbamfs7tbhSmQ1Uz7" target="_blank" rel="noopener noreferrer">
		...
		steps: {
			what: (
				<React.Fragment>
					...
					holds a public hearing and makes a recommendation for action to City Council. For downtown Level II projects,
					the Planning and Zoning Commission verifies technical compliance with the requirements of applicable
		...
		steps: {
			what: (
				<React.Fragment>
					...
					<a href="https://www.ashevillenc.gov/government/meet-city-council/" target="_blank" rel="noopener noreferrer">
						City Council
					</a>
					. These projects arrive at the City Council meeting with a recommendation for action that has been sent by the
					Planning and Zoning Commission.
				</React.Fragment>
			),
			who: ["dev", "staff", "neighbors", "council"],
