...
export const statusTranslation = [
	...
	},
	{
		...
		statusText:
			"The Planning & Zoning Commission has completed review of the project and the next step is a public hearing before City Council.",
	},
	{
		accelaSpeak: "Closed",
		statusText: "",
	...
	},
	{
		accelaSpeak: "Expired",
		statusText:
			"This project was approved, but too much time has passed since that approval and the approval has now expired.",
		closed: true,
	},
	{
		accelaSpeak: "Finaled",
	...
	},
	{
		...
		statusText:
			"City Council has approved this project. The next step is for the developer to submit detailed applications for development permits.",
	},
	{
