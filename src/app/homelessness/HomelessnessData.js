  ...
  <div>
    ...
    <div className="row">
      <div className="col-sm-12">
        <h2>Overview page data sources</h2>
        <p>
        ...
        <hr />
        <h2>Veterans page data sources</h2>
        <p>The primary source of information for the Homelessness Data Dashboard’s Veteran Page is the Veteran By-Name List. The Veteran By-Name List is a comprehensive list of homeless Veterans in the community.</p>
        <p>The list ensures that service providers and key partners are working together to achieve ‘Functional Zero’ and have identified all Veterans who require housing and/or services in the community. This list is populated through information from street and VA outreach, the Homeless Management Information System (HMIS), community shelters, VA-funded programs including GPD providers, and any other provider who may work with Veterans experiencing homelessness. The Asheville-Buncombe Continuum of Care participates in the statewide database (NC HMIS) to measure the needs of homeless persons, coordinate their care and report the outcome of these services.</p>
        <p>Agencies are not allowed to collect or share this information without client consent and the data is essential to providing services. For this reason, only aggregate data is reported on this dashboard.</p>
      </div>
    </div>
  </div>
);
