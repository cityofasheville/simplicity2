...
const HomelessnessDemographics = props => (
  <div>
    <div className="row">
      <div className="col-sm-12">
        <h3>Who is homeless?</h3>
        <p>
          A few sentences about the demographics of homelessness in Asheville / Buncombe County.
        </p>
      </div>
    </div>
    <div className="row">
      <div className="col-sm-6">
        <BarChartContainer chartTitle="Target populations" layout="vertical" chartText="Target populations of the homeless - why are the target populations what they are and what is the purpose of organizing them in this way" mainAxisDataKey="Year" legendHeight={20} dataKeys={props.targetPopKeys} colorScheme="purple_green_diverging" data={props.targetPopData} stacked altText="Bar chart of homelessness over the last 12 years in target populations" />
      </div>
      <div className="col-sm-6">
        <BarChartContainer chartTitle="Family units" layout="vertical" chartText="A concern often raised is about children who are homeless. This chart shows a breakdown of homeless families and children compared to homeless adults." mainAxisDataKey="date" legendHeight={20} dataKeys={props.familySituationKeys} colorScheme="pink_green_diverging" data={props.familySituationData} stacked altText="Bar chart of homelessness by family situation" />
      </div>
    </div>
  </div>
);
