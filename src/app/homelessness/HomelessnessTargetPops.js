...
class HomelessnessTargetPops extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div>
        ...
        <p>
         Text Block 4: What are the target populations, why are these the target populations, etc. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text. Placeholder text.
        </p>
        <div className="row">
        ...
        <div className="row">
          <div className="col-sm-12">
            <BarChart data={this.props.summaryData} xAxisDataKey="Year" barDataKeys={dataKeys} stacked colorScheme="pink_green_diverging" altText={'Bar chart of homelessness over the last 12 years: target populations'} />
          </div>
        </div>
        <div className="row">
          <div className="col-xs-10 col-xs-offset-2">
            ...
            <a href="javascript:void(0);" className="text-center inText" onClick={() => this.toggleLongDesc()}>
              {this.state.showingLongDesc ? 'Hide' : 'Show'} Homlessness over the last 12 years: Target populations bar chart summary
            </a>
...
HomelessnessTargetPops.propTypes = {
  summaryData: PropTypes.arrayOf(PropTypes.shape(dataShape)),
  showLongDesc: PropTypes.bool, // eslint-disable-line
};

HomelessnessTargetPops.defaultProps = {
  summaryData: data,
  showLongDesc: false,
};

export default HomelessnessTargetPops;
