...
const getIcon = (type) => {
  switch (type) {
    case 'Priority 1':
      return <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><text x="7" y="24" fontFamily="sans-serif" fontSize="24" fill="#fff">1</text></svg>;
    case 'Priority 2':
      return <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><text x="7" y="24" fontFamily="sans-serif" fontSize="24" fill="#fff">2</text></svg>;
    case 'Priority 3':
      return <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><text x="7" y="24" fontFamily="sans-serif" fontSize="24" fill="#fff">3</text></svg>;
    case 'Project Small  5-20 Hrs':
    case 'Project Small':
    case 'Project Small 5-20 Hrs':
      return <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><text x="7" y="24" fontFamily="sans-serif" fontSize="24" fill="#fff">S</text></svg>;
    case 'Project Large':
    case 'Project Larger 100 Hrs':
      return <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><text x="7" y="24" fontFamily="sans-serif" fontSize="24" fill="#fff">L</text></svg>;
    case 'Project Medium':
    case 'Project Medium 20-100 Hrs':
      return <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><text x="4" y="24" fontFamily="sans-serif" fontSize="24" fill="#fff">M</text></svg>;
    default:
