...
const GET_PCARDTRANSACTIONS = gql`
  query pcard_transactions($before: String, $after: String) {
...
const PCardComplianceReceipts = props => (
  ...
  >
    {({ loading, error, data }) => {
      ...
      const transactions = buildReceiptsTree(data.pcard_transactions);
      const filteredTransactions = findTop(transactions, props.location.query.nodePath || 'root_01')
            ...
            <div className="data-filters__container">
              <div className="data-filters__inner">
                <div className="form-group">
                  ...
                  >
                    {
                      transactions.children.map((dept) => {
                        if (dept.key !== null) {
...
export default PCardComplianceReceipts;
