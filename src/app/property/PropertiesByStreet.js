    ...
    <div>
      <div className="row">
        <div className="col-sm-12">
          <EmailDownload
            downloadData={props.data.properties_by_street}
            fileName="properties_by_street.csv"
          />
        </div>
          ...
          {props.data.properties_by_street.length < 1 ? (
            ...
            <div alt={['Table of addresses'].join(' ')} style={{ marginTop: '10px' }}>
              <ExpandableAccessibleReactTable
                ...
                defaultPageSize={
                  props.data.properties_by_street.length <= 20
                    ? props.data.properties_by_street.length
                    : 20
                }
                filterable
