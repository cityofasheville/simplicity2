...
const SearchByEntity = props => (
  <div onClick={() => props.onClick(props.entity.type)}>
    <input
      ...
      checked={props.entity.checked}
      readOnly
    />
    {getIcon(props.entity.type)}
    <span
      className={
        props.entity.checked === true
          ? ['text-primary', styles.entityDescription].join(' ')
          : styles.entityDescriptionUnchecked
      }
    >
      {props.entity.label}
    </span>
