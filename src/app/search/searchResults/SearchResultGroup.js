	...
	const dataColumns = [
		{
			...
			Header: (
				<h2 className="border-2 border-blue-100 text-4xl items-center text-coa-medium-blue w-full inline-flex py-5 px-1">
					...
					<span
						className="flex items-center justify-center h-6 ml-2 min-w-6 inline-block min-w-3 px-2 py-1 text-xs font-medium text-white align-middle text-center bg-coa-blue-medium rounded-full"
					>
