...
const DetailsFormGroup = (props) => {
	const displayValue = props.value === null || props.value === undefined || props.value === "" ? "No Data" : props.value;
	...
	return (
		...
		<div className="">
			<div className="p-4 bg-gray-200 h-full">
				<h3 className="pb-4 mb-2 border-b-2 border-gray-300 flex items-baseline">
					{props.icon !== null && (
