export const colorSchemes = {
  pink_green_diverging: [
    ...
    '#276419',
    '#f7f7f7',
  ], // color brewer diverging 11 pink-green
  purple_green_diverging: [
    ...
    '#00441b',
    '#f7f7f7',
  ], // color brewer diverging 11 purple-green
  brown_blue_diverging: [
    '#543005',
    '#c7eae5',
    '#8c510a',
    '#80cdc1',
    ...
    '#003c30',
    '#f5f5f5',
  ], // color brewer diverging 11 brown-blue
  red_blue_diverging: [
    '#67001f',
    '#d1e5f0',
    '#b2182b',
    ...
    '#053061',
    '#f7f7f7',
  ], // color brewer diverging 11 red-blue
  orange_purple_diverging: [
    ...
    '#2d004b',
    '#f7f7f7',
  ], // color brewer diverging 11 orange-purple
  single_hue_green_blue: [
    '#deebf7',
    '#c6dbef',
    '#9ecae1',
    '#6baed6',
    ...
    '#006d2c',
    '#00441b',
  ], // color brewer single hue blue - single hue green
  single_hue_blue_green: [
    '#e5f5e0',
    '#c7e9c0',
    '#a1d99b',
    '#74c476',
  ...
  bright_colors: [
    ...
    '#6DB6FF',
    '#FFBDDB',
  ], // bright colors 1 colorblind 'safe'
  ...
  bright_colors_2: [
    ...
    '#6DB6FF',
    '#490092',
  ], // bright colors 2 colorblind 'safe'
  ...
  blue_red_grouped: [
    ...
    '#ef3b2c',
    '#a50f15',
  ], // three blue, three red, colorblind 'safe',
...
export const referenceColorScheme = ['#fcfcfc', '#f0f0f0', '#d9d9d9'];
