        ...
        <h1>
          ...
          <div className="pull-right">
            <div className="btn-group">
              <Link to={{ pathname: '/topics/budget/details', query: { entity: props.location.query.entity, id: props.location.query.id, label: props.location.query.label, mode: 'expenditures' } }}>
              ...
              <Link to={{ pathname: '/topics/budget/details', query: { entity: props.location.query.entity, id: props.location.query.id, label: props.location.query.label, mode: 'revenue' } }}>
