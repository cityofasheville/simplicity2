...
const getMaintenanceInfo = (entity, comma) => {
  ...
  if (entity === 'CITY OF ASHEVILLE') {
    return (<div><span><a href="http://www.ashevillenc.gov/departments/street_services/maintenance.htm" target="_blank">{entity}</a></span><span style={{ marginLeft: '10px' }}><a className="btn btn-sm btn-warning inline-flex" href="https://iframe.publicstuff.com/#?client_id=819" target="_blank">Report with the Asheville App</a>
    </span></div>);
  }
  if (entity === 'NCDOT') {
